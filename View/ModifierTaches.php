...
<header class="navbar">
 ...
 <div class="container">
  ...
  <div class="box-b">
  <h1 class="do_tache">Modifier votre Tache</h1>
     <form class="form_t" action="../Controlleur/ModifierTache_control.php?id=<?php echo $resultat_all[0]['id']; ?>" method="post">
    <div class="Option_All">
    <input class="select_form"  name="libelle" id="libelle" value="<?php echo $resultat_all[0]['libelle'] ;?> " type="text"> 
     <input class="select_form" name="date" id="date" value="<?php echo $resultat_all[0]['date'] ;?> " type="datetime-local">
    </div>   

      <textarea class="textatera_form"  name="description" id="description"  cols="30" rows="15"><?php echo $resultat_all[0]['description'] ;?>"</textarea>
      <div class="Option_All">
      ...
      <select class="select_form2" name="etat" id="etat">
       ...
       <button class="btn" name="save_Modifie_tache" type="submit" id="save_tache"> Confirmer </button>
     </form>
